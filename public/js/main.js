// let num = prompt('ur number')

// let reverseNumber = (a) => {
//     return a.reverse()
// }
// let choice = reverseNumber(123)
// console.log(choice);
...
let divPar2 = (nombre) => {
    switch (nombre % 2 === 0) {
        case true:
            return 'ce nombre est divisible par 2'
        // case a % 2!= 0:
            default:
...
console.log(divPar2(8));

// EXO3 //

// let mdp = prompt('Ajoutez un mot de passe')
...
let ajout = prompt('entrer le nom de la personne')
let suppr = prompt('voulez vous supprimez une personne ?')
let classe = [];
